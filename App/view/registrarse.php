<?php require_once __DIR__ . "/../controllers/UsuarioController.php"; ?>
<!DOCTYPE html>
<html lang="es">
...
<body>
    ...
    <nav class="header__navigation">
      <ul class="header__navigation-list">
        ...
        <li class="header__navigation-li">
          <a class="header__navigation-item2 header__navigation-item--selected" href="/App/view/registrarse.php">
            <i class="fa-solid fa-user"></i>
            <span style="margin-left: 4px;">Registrarse</span>
          </a>
        <li class="header__navigation-li"><a class="header__navigation-item " href="/App/view/login.php">Iniciar Sesion</a></li>
        </li>
      </ul>
    </nav>
  </header>
  ...
  <main>
    ...
    <div class="formulario">
      <form id="formulario" class="form" name="contact-form" action="/App/controllers/UsuarioController.php" method="POST" onsubmit="return validarFormulario(event)">
        ...
        <div class="form-body">
          <div>
            ...
            <input class="input-text" type="text" name="Documento" id="Documento">
          </div>
          ...
          <div>
            ...
            <input class="input-text" type="text" name="Apellidos" id="Apellidos">
          </div>

          <div>
            <label class="label">Edad:</label>
            <input class="input-text" type="number" name="Edad" id="Edad">
          </div>
          ...
          <div>
            ...
            <input class="input-text" type="password" name="ConfirmarContraseña" id="ConfirmarContraseña">
          </div>

        </div>

        <input class="button" type="submit" value="Registrarse" name="registrarse">
      </form>
    </div>
  </main>
