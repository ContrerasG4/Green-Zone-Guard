<?php
require_once(__DIR__ . '/../controllers/controllers_index.php');
?>
    ...
    <header class="header">
        ...
        <nav class="header__navigation">
            <ul class="header__navigation-list">
                <li class="header__navigation-li"><a class="header__navigation-item header__navigation-item--selected" href="/App/view/index.php">Inicio</a></li>
