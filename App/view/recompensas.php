...
$isLoggedIn = isset($_SESSION['usuario']); // Cambia 'usuario' por el nombre real de tu variable de sesión

require_once __DIR__ . "/../models/conexion.php";
require_once __DIR__ . "/../controllers/Controller_Recompensas.php";

// Crear instancia del controlador con la conexión
$controller = new Controller_Recompensas($conn);

// Obtener las recompensas
$recompensas = $controller->mostrarRecompensas(); // Ahora solo devuelve datos
?>
<!DOCTYPE html>
        ...
        <nav class="header__navigation">
            <ul class="header__navigation-list">
                <li class="header__navigation-li"><a class="header__navigation-item "
                        href="/App/view/index.php">Inicio</a></li>
                <li class="header__navigation-li"><a class="header__navigation-item"
                        href="/App/view/nosotros.html">Nosotros</a></li>
                <li class="header__navigation-li"><a class="header__navigation-item"
                        href="/App/view/eventos.html">Eventos</a></li>
                <li class="header__navigation-li"><a class="header__navigation-item"
                        href="/App/view/contacto.php">Contacto</a></li>
                <li class="header__navigation-li"><a class="header__navigation-item header__navigation-item--selected"
                        href="/App/view/recompensas.php">Recompensas</a></li>
                ...
                <li class="header__navigation-li"><a class="header__navigation-item " href="/App/view/login.php">Iniciar
                        Sesion</a></li>
                </li>
            </ul>
        </nav>
    ...
    <main class="recompensas">
        ...
        <div class="image-gallery">
            ...
            <div class="image-container">
                ...
                <img src="../view/uploads/<?php echo $row['foto']; ?>" alt="Imagen"
                ...
                <div>
                    ...
                    document.getElementById('claimForm').addEventListener('submit', function(event) {
                        ...
                        if (!isLoggedIn) {
                            ...
                            alert('Debes iniciar sesión o registrarte para reclamar una recompensa.');
                            window.location.href = 'login.php'; // Redirige al login
                        }
                        // Si está logueado, se envía normalmente al action definido en el backend
                    });
                    </script>
                    </form>
                </div>
        ...
        <section class="detalles-recompensas ">
            ...
            <p>Desde libretas personalizadas, hasta hermosos bolsos donde podras llevar lo que mas gustes, estas
                recompensas están diseñadas para premiar <br> tu esfuerzo y compromiso con el cuidados de nuestros
                parques y se obtienen por la participación
                a los diferentes eventos de cuidado. Mientras <br> mas participes mayor sera tu premio (acepta terminos
                y condiciones).</p>
        </section>
        ...
        <section class="testimonios ">
            ...
            <div class="testimonio ">
                <p>"Participar en esta campaña me ha permitido conocer más sobre la importancia de nuestras zonas
                    verdes, ¡y además he recibido excelentes recompensas! "</p>
